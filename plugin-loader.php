...
function simple_backup_activate() {
	...
	if ($_GET['action'] == 'error_scrape') {                                                                                                   
	    die("Sorry, Simple Backup Plugin requires PHP 5.3 or higher. Please deactivate Simple Backup Plugin.");                                 
	}
...
if ( version_compare( phpversion(), '5.3', '>=') ) {
	...
	require_once(dirname(__FILE__) . '/simple-backup-manager.class.php');
	require_once(dirname(__FILE__) . '/backup-list-table.class.php');
